...
class Map_loader:
    ...
    def judgment_is_legal_normal_mode(self) -> bool:
        return 0 <= self.now_x < 12 and 0 <= self.now_y < 12
    ...
    def normal_mode(self):
        ...
        self.screen.blit(self.appearance, (3 + 24 * 6, 3))
        self.screen.blit(self.appearance, (3 + 24 * 11, 3))

        # 画我方坦克
        self.screen.blit(self.tank_l1, (3 + 2 * 24, 3 + 11 * 24))
        self.screen.blit(self.tank_l2, (3 + 9 * 24, 3 + 11 * 24))
    ...
    def function(self,is_normal_mode):
        ...
        while True:
            ...
            if self.moving:
                ...
                if self.movdir == 1 and self.moving == 0 and self.now_x < 11:
                    self.now_x += 1

                if self.movdir == 2 and self.moving == 0 and self.now_y > 0:
                    self.now_y -= 1

                if self.movdir == 3 and self.moving == 0 and self.now_y < 11:
                    self.now_y += 1
